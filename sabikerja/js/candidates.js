document.addEventListener("DOMContentLoaded", function () {
    // Button - home
    const buttons = {
        ".join-btn": "/candidates/jobs.html",
        ".search-job": "/candidates/jobs.html",
        ".apply-job": "/candidates/jobs.html",
        ".sponsor-button": "/candidates/jobs.html"
    };
    ...
    if (loginForm) {
        ...
        employerBtn.addEventListener('click', function () {
            handleLogin('Employer', 'list.html');
        });
